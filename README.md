...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/GoreML/ibm-fullstack_developer_capstone.git
...
2. **Install backend dependencies:**
   ...
   ```bash
    cd /home/project/ibm-fullstack_developer_capstone/server
...
```
├── server/
|   ├── database/    # database backend (Mongo)
...
# Updated Sun Jul 12 09:22:23 EDT 2026
